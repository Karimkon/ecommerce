...
class SubCategoryController extends Controller
{
    ...
    public function insert(Request $request)
    {
        ...
        return redirect('admin/sub_category/list')->with('success', "Sub category Succesfully created.");
    } 
    ...
    public function update($id, Request $request)
    {
        ...
        return redirect('admin/category/list')->with('success', "Sub Category Succesfully Updated.");
    } 
