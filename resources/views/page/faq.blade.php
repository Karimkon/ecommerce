            ...
            <div class="accordion accordion-rounded" id="accordion-1">
                <div class="card card-box card-sm bg-light">
                    ...
                    <div id="collapse-1" class="collapse show" aria-labelledby="heading-1" data-parent="#accordion-1">
                        <div class="card-body">
                            Your parcel will be delivered via our trusted shipping partners. You will receive updates on the delivery status once your order has been shipped.                        </div><!-- End .card-body -->
                    </div><!-- End .collapse -->
                </div><!-- End .card -->
                ...
                <div class="card card-box card-sm bg-light">
                    ...
                    <div id="collapse-2" class="collapse" aria-labelledby="heading-2" data-parent="#accordion-1">
                        <div class="card-body">
                            Yes, delivery charges may apply depending on your location and the shipping method chosen at checkout.                        </div><!-- End .card-body -->
                    </div><!-- End .collapse -->
                </div><!-- End .card -->
                ...
                <div class="card card-box card-sm bg-light">
                    ...
                    <div id="collapse-3" class="collapse" aria-labelledby="heading-3" data-parent="#accordion-1">
                        <div class="card-body">
                            Customs fees may apply depending on your country's regulations. These fees are the responsibility of the customer.
                        </div><!-- End .card-body -->
                    </div><!-- End .collapse -->
                </div><!-- End .card -->
                ...
                <div class="card card-box card-sm bg-light">
                    ...
                    <div id="collapse-4" class="collapse" aria-labelledby="heading-4" data-parent="#accordion-1">
                        <div class="card-body">
                            If your item becomes faulty, please contact our customer service team for assistance. We may offer a replacement or refund depending on the circumstances.                        </div><!-- End .card-body -->
                    </div><!-- End .collapse -->
                </div><!-- End .card -->
            </div><!-- End .accordion -->
            ...
            <div class="accordion accordion-rounded" id="accordion-2">
                ...
                <div class="card card-box card-sm bg-light">
                    ...
                    <div id="collapse2-2" class="collapse" aria-labelledby="heading2-2" data-parent="#accordion-2">
                        <div class="card-body">
                            If you haven't received your order within the estimated delivery time, please contact our customer service team for assistance.                        </div><!-- End .card-body -->
                    </div><!-- End .collapse -->
                </div><!-- End .card -->
                ...
                <div class="card card-box card-sm bg-light">
                    ...
                    <div id="collapse2-3" class="collapse" aria-labelledby="heading2-3" data-parent="#accordion-2">
                        <div class="card-body">
                            To return an item, please follow the instructions provided in our Returns Policy. You can initiate a return request through your account dashboard or by contacting our customer service team.
                         </div><!-- End .card-body -->
                    </div><!-- End .collapse -->
                </div><!-- End .card -->
            ...
            <div class="accordion accordion-rounded" id="accordion-3">
                <div class="card card-box card-sm bg-light">
                    ...
                    <div id="collapse3-1" class="collapse" aria-labelledby="heading3-1" data-parent="#accordion-3">
                        <div class="card-body">
                            We accept various payment methods including credit/debit cards, PayPal, and bank transfers. You can view all available payment options at the checkout page.
                         </div><!-- End .card-body -->
                    </div><!-- End .collapse -->
                </div><!-- End .card -->
                ...
                <div class="card card-box card-sm bg-light">
                    ...
                    <div id="collapse3-2" class="collapse" aria-labelledby="heading3-2" data-parent="#accordion-3">
                        <div class="card-body">
                            Yes, you can pay using a Gift Card issued by our store. Simply enter the Gift Card code during the checkout process.                        </div><!-- End .card-body -->
                        </div><!-- End .collapse -->
                </div><!-- End .card -->
            </div>
                ...
                <div class="card card-box card-sm bg-light">
                    ...
                    <div id="collapse3-3" class="collapse" aria-labelledby="heading3-3" data-parent="#accordion-3">
                        <div class="card-body">
                            If you are experiencing issues making a payment, please ensure that your payment information is entered correctly. You may also try using a different payment method or contact your bank for assistance.
                        </div><!-- End .card-body -->
                    </div><!-- End .card-body -->
                </div><!-- End .card -->
                ...
                <div class="card card-box card-sm bg-light">
                    ...
                    <div id="collapse3-4" class="collapse" aria-labelledby="heading3-4" data-parent="#accordion-3">
                        <div class="card-body">
                            Once your payment has been successfully processed, you will receive a confirmation email with details of your transaction. If you haven't received a confirmation email, please check your spam folder or contact our customer service team for assistance.                        </div><!-- End .card-body -->
                    </div><!-- End .collapse -->
                </div><!-- End .card -->
            </div><!-- End .accordion -->
        </div><!-- End .container -->
                ...
                <div class="col-md-10 col-lg-9 col-xl-7">
                    <div class="row no-gutters flex-column flex-sm-row align-items-sm-center">
                        <div class="col">
                            ...
                            <p class="cta-desc text-white">Please click on the button on your right 👉</p><!-- End .cta-desc -->
                        </div><!-- End .col -->
