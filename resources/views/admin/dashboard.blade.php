  ...
  <div class="content">
    ...
    <div class="clearfix hidden-md-up"></div>
        ...
        <div class="col-12 col-sm-6 col-md-3">
            ...
            <span class="info-box-number">{{ $TotalTodayOrders }}</span>
          </div>
        </div>
        </div>
        ...
        <span class="info-box-number">${{ $TotalTodayPayments }}</span>
      </div>
    </div>
    </div>
      ...
      <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <select class="form-control ChangeYear" name="" style="width: 100px;">
          ...
          <div class="card">
            <div class="card-header border-0">
              <h3 class="card-title">Latest Orders <strong> </strong> Products available</h3>
            </div>
            ...
            datasets: [
                {
                    ...
                    borderColor: '#007bff',
                    data: @json($getTotalCustomerMonth)
                },
                {
                    label: 'Orders',
                    backgroundColor: '#ced4da',
                    borderColor: '#ced4da',
                    data: @json($getTotalOrderMonth)
                },
                {
                    label: 'Amount',
                    backgroundColor: 'red',
                    borderColor: 'red',
                    data: @json($getTotalOrderAmountMonth)
                }
            ]
        },
    options: {
