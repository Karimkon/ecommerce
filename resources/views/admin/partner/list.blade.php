      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6" style="text-align: right;">
            <a href="{{ url('admin/partner/add') }}" class="btn btn-primary">Add New Partners</a>
          </div>
    ...
    <section class="content">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Search Partners</h3>
            </div>
            <form method="get" action="">
              <div class="card-body">
                ...
                <div class="form-group col-md-3">
                  ...
                  <a href="{{ url('admin/partner/list') }}" style="margin-top: 30px" class="btn btn-success">Reset</a>
                </div>
                </div>
