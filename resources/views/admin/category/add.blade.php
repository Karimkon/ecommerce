              ...
              <form method="post" action="" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="button_name"  placeholder="Enter Category Name">
                  </div>
                  ...
                  <div class="form-group">
                    <label style="display : block;">Nav Bar Menu <span style="color: red"></span></label>
