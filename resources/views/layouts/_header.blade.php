            ...
            <div class="header-right">
                <ul class="top-menu">
                    <li>
                        <a href="#">Links</a>
                        <ul>
                            <li><a href="tel:{{ $getSystemSettingApp->phone }}"><i class="icon-phone"></i><strong>Call: {{ $getSystemSettingApp->phone }}</strong></a></li>
                            @if(!empty(Auth::check()))
                            @php
                                $wishlistCount = App\Models\ProductWishlistModel::where('user_id', Auth::user()->id)->count();
                            @endphp
                            <li><a href="{{ url('my-wishlist') }}"><i class="icon-heart-o"></i>My Wishlist <span>({{ $wishlistCount }})</span></a></li>
                            @else
                            <li><a href="{{ url('#signin-modal') }}" data-toggle="modal"><i class="icon-heart-o"></i>My Wishlist <span>(0)</span></a></li>
                            @endif

                            <li><a href="{{ url('about') }}">About Us</a></li>
                            <li><a href="{{ url('contact') }}">Contact Us</a></li>
                            @if(!empty(Auth::check()))
                            <li><a href="{{ url('users/dashboard') }}"><i class="icon-user"></i>{{ Auth::user()->name }}</a></li>
                            @else
        ...
        <div class="container">
            <div class="header-left">
                ...
                <!-- <a href="{{ url('') }}" class="logo">
                 ...
                 <a href="{{ url('') }}" class="logo">
                    <img src="{{ $getSystemSettingApp->getLogo() }}" width="165" height="55">
                </a>
