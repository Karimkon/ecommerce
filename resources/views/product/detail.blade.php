                            ...
                            <div class="col-md-6">
                                <div class="product-details">
                                    ...
                                    <div class="ratings-container">
                                        ...
                                        <a href="#product-review-link" class="ratings-text" id="review-link">( {{ $getProduct->getTotalReview() }} Review / s)</a>
                                    </div>
                                    ...
                                    <div class="product-details-action">
                                        ...
                                        <div class="details-action-wrapper">
                                            @if(!empty(Auth::check()))
                                            <a href="javascript:;" class="add_to_wishlist add_to_wishlist{{ $getProduct->id }} {{ !empty($getProduct->checkWishlist($getProduct->id)) ? 'btn-wishlist-add' : ''}}
                                             btn-product btn-wishlist" id="{{ $getProduct->id }}" title="Wishlist"><span>Add to Wishlist</span></a>
                                    ...
                                    <div class="review">
                                        <div class="row no-gutters">
                                            <div class="col-auto">
                                                ...
                                                <div class="ratings-container">
                                                    <div class="ratings">
                                                        <div class="ratings-val" style="width: {{ $review->getRatingsPercentage() }}%;"></div>
                                                    </div>
                                                </div>
